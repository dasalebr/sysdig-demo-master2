pipeline {
  ...
  stages {
    ...
    stage('Scan Image') {
      steps {
        sh "docker run --rm quay.io/sysdig/secure-inline-scan:2 andreamendoza/podinfo:${env.BUILD_NUMBER} -k 55d7691b-d862-47a5-980d-c3f1e8c7c039 -s https://secure.sysdig.com"
